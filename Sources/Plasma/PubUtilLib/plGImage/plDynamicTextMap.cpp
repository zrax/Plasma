...
bool    plDynamicTextMap::MsgReceive( plMessage *msg )
{
    ...
    if( textMsg != nil )
    {
        ...
        if( textMsg->fCmd & plDynamicTextMsg::kSetFont )
        ...
        if( textMsg->fCmd & plDynamicTextMsg::kDrawString )
            DrawString_TEMP( textMsg->fX, textMsg->fY, textMsg->fString );

        if( textMsg->fCmd & plDynamicTextMsg::kDrawClippedString )
            DrawClippedString_TEMP( textMsg->fX, textMsg->fY, textMsg->fString,
                                    textMsg->fLeft, textMsg->fTop, textMsg->fRight - textMsg->fLeft + 1,
                                    textMsg->fBottom - textMsg->fTop + 1 );

        if( textMsg->fCmd & plDynamicTextMsg::kDrawWrappedString )
            DrawWrappedString_TEMP( textMsg->fX, textMsg->fY, textMsg->fString, textMsg->fRight, textMsg->fBottom );

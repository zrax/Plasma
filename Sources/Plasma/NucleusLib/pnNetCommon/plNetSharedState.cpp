...
plNetSharedState::plNetSharedState(const plString& name) : fServerMayDelete(false)
{ 
    SetName(name);
}
...
{   
    ...
    plMsgPlStringHelper::Peek(fName, stream);
...
{   
    plMsgPlStringHelper::Poke(fName, stream);
